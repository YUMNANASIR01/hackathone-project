    ...
    <nav className="relative w-full bg-white">
      ...
      <div className="max-w-[1286px] mx-auto px-4 lg:ml-[60px] sm:px-0 ml-[51px] sm:ml-0 flex items-center justify-between h-[41px] mt-[29px]">
        ...
        <div className="flex items-center gap-1 xsm:ml-[100px]">
          <h1 className="xsm:text-[30px] sm:ml-0 md:ml-[-80px] md:p-0 font-bold font-montserrat text-[25px] ml-20 text-black flex items-center gap-4">
            <div>
              <Image
                src={'/logo.png'}
                alt={'Logo'}
        ...
        {/* Icons Section */}
        <div className="hidden sm:flex md:items-center gap-6 sm:pr-[90px]">
